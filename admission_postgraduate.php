					...
					<div class="container" >
						<div class="row" style="margin-top:-5px;">
                            ...
                            <h1 style="font-size:large;">Admissons</h1>
								<span class="sub-title">Postgraduate Admissions</span>
							</div>
							<div class="col-md-4 order-1 order-md-2 align-self-center">
								<ul class="breadcrumb d-block text-md-end breadcrumb-light">
									<li><a href="index.php">Home</a></li>
									<li class="active">Postgraduate Admissions</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container">
                    ...
                    <?php include 'admissionsidebar.php'; ?>
						<div class="col">
                            ...
                            <h4>Eligibility</h4>
                            <p>MBA: Should be a Graduate from any recognised University.</p>
                            <p>MCA: Pass in any recognized Bachelor degree course of minimum 3 years duration in any discipline with Mathematics as one of the subjects.</p>
                            <p>MCA: Pass in any recognized Bachelor degree course of minimum 3 years duration in any discipline with Mathematics as one of the subjects.</p>
