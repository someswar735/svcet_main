...
<head>
    ...
    <style>
        ...
        .middle-soon-image img {
            max-width: 70%; /* Adjust the percentage to your desired medium size */
            height: auto;
            display: block;
            ...
            <div class="container">
                <div class="row mt-5 mb-4">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="middle-soon-image">
                            <img src="img/BackgroungImg/soon image.png" alt="Coming Soon Image">
                        </div>
                    </div>
                </div>
            </div>
