...
">
            ...
            <div class="container">
                ...
                <div class="row mt-5 mb-4">
                    ...
                    <div class="col">
                    <h3 class="font-weight-semibold mb-3">List of Faculty in AIML Department</h2>
                    <hr>
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>sudheergurugubelli@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>02</td>
                                    <td>KONDALA HEMALATHA</td>
                                    <td>Assistant Professor</td>
                                    <td>hemalatha.kondala111@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>03</td>
                                    <td>H. SRINIVASRAO</td>
                                    <td>Assistant Professor</td>
                                    <td>mcasrinu13@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>04</td>
                                    <td>G. SRINIVASA RAO</td>
                                    <td>Assistant Professor</td>
                                    <td>guntukusrinu24@gmail.com</td>
                                </tr>
