...
">
					<div class="container" >
						<div class="row" style="margin-top:-5px;">
                            ...
                            <h1 style="font-size:large;">P & T</h1>
								<span class="sub-title">Placement & Contact Details</span>
							</div>
							<div class="col-md-4 order-1 order-md-2 align-self-center">
								<ul class="breadcrumb d-block text-md-end breadcrumb-light">
									<li><a href="index.php">Home</a></li>
									<li class="active">Placement & Contact Details</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container">
                    ...
                    <?php include 'Placements_sidebar.php'; ?>
						<div class="col">
                          ...
                          <h2 class="font-weight-semibold mb-3">PLACEMENT CONTACT DETAILS :</h2>

							<h4 class="font-weight-semibold mb-3">We have a team for Plcaements & Training</h4>
							 
                            <h4 class="font-weight-semibold mb-3">Please Contact Our Plcaements & Training center</h4>
						  
                            <h1 class="font-weight-semibold mb-3">+919494011444</h1>
