...
">
                <div class="container">
                    <div class="row" style="margin-top:-5px;">
                        ...
                        <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                            <h1 style="font-size:large;">AIML & CSM</h1>
                        ...
                        <div class="col-md-4 order-1 order-md-2 align-self-center">
                            <ul class="breadcrumb d-block text-md-end breadcrumb-light">
                                ...
                                <li class="active"> About AIML & CSM</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row mt-5 mb-4">
                    <?php include 'aiml_menu.php'; ?>
                    <div class="col">


                        <h2 class="font-weight-semibold mb-3">DEPARTMENT PROFILE</h2>
                        <p>Sri Venkatesawara College of engineering and Technology offers a four-year under-graduate B.Tech course in Artificial Intelligence and Machine Learning which aims to develop a strong foundation by using the principles and technologies that consist of many facets of Artificial Intelligence including logic, knowledge representation, probabilistic models, and machine learning. This course is best suited for students seeking to build world-class expertise in Artificial Intelligence and Machine Learning and emerging technologies which help to stand in the crowd and grow careers in the upcoming technological era.</p>
