...
<head>
    ...
    <title>Programme Educational Objectives and Outcomes</title>

    <meta name="keywords" content="Education, Objectives, Outcomes" />
    <meta name="description" content="Programme Educational Objectives and Outcomes">
                ...
                <div class="container">
                    <div class="row" style="margin-top:-5px;">
                        <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                            <h1 style="font-size:large;">Programme Educational Objectives and Outcomes</h1>
                            <span class="sub-title">Academics</span>
                        </div>
                        ...
                        <div class="blog-posts single-post">
                            <article class="post post-large blog-single-post border-0 m-0 p-0">
                                <div class="post-content ms-0">
                                    <h3 class="font-weight-semibold mb-3">Programme Educational Objectives:</h3>
                                    <ul>
                                ...
                                <div class="post-content ms-0">
                                    <h3 class="font-weight-semibold mb-3">Program Outcomes</h3>
                                    <ol>
                                        ...
                                        <li><strong>Problem analysis:</strong> Identify, formulate, research literature, and analyze complex engineering problems reaching substantiated conclusions using first principles of mathematics, natural sciences, and engineering sciences.</li>
