...
<head>
	...
	<title>Skill Enhancement Activities</title>
	...
	<div class="body">
		...
		<div role="main" class="main">
			...
			<section class="page-header page-header-modern page-header-md"
				style="background-color:#840103; height:6px; margin-Bottom:-10px; padding-top:20px;">
				<div class="container">
					<div class="row" style="margin-top:-5px;">

						<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                            <h1 style="font-size:large;">ACTIVITES</h1>
							<span class="sub-title">Skill Enhancement </span>
						</div>
						<div class="col-md-4 order-1 order-md-2 align-self-center">
							<ul class="breadcrumb d-block text-md-end breadcrumb-light">
								<li><a href="index.php">Home</a></li>
								<li class="active">Skill Enhancement Activities</li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row mt-5 mb-4">
					...
					<div class="col">
						<h3 class="font-weight-semibold mb-3">Skill Enhancement Activities</h3>
						<hr>
